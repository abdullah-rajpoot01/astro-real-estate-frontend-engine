...
function PropertyTypeListingPage({ listings, propertyType }: { listings: Listing[], propertyType: string }) {
    ...
    return (
        <section className='pb-10'>
            <div className='mx-auto w-full max-w-7xl'>
                ...
                {listings.length === 0 ? <EmptyListingsState /> : <ListingCard1 listings={listings} maxItems={PropertiesTypeListingPageConfig.listingPerPage} />}
