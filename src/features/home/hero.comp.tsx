...
import { getHeroSection } from "@/features/home";
    ...
    return (
        <section id="hero" className="">
            <div className=" grid gap-5 lg:grid-cols-2 lg:items-center">
                ...
                <div className="relative overflow-hidden max-w-md lg:aspect-square mx-auto border dark:border-card-foreground/70 bg-card rounded-lg w-full h-full">
